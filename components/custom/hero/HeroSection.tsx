  ...
  return (
    <section className="hero">
      ...
      <div className="hero__video-bg">
        <iframe
          src="https://customer-ip9lnkk65px0t3ak.cloudflarestream.com/adec63d83b9858314d12bd3fbd585c55/iframe?autoplay=true&muted=true&loop=true&controls=false&playsinline=true"
          style={{
            position: "absolute",
            top: "50%",
            left: "50%",
      ...
      <div className="hero__content">
        ...
        <p className="hero__description" ref={descRef}>
          Panel upgrades, EV chargers, historic rewires, dock &amp; marina electrical,
          <br />
          and FPL undergrounding — family owned, honest pricing, 24/7 emergency service.
        </p>
