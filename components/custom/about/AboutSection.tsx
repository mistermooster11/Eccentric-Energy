      ...
      <div className="about__container">
        ...
        <div className="about__content">
          ...
          <h2 className="about__heading">
            Trusted Electrical Contractor in
            West Palm Beach &amp; Palm Beach County
          </h2>
          <p className="about__text">
            Eccentric Energy is a family owned electrical contractor serving Palm Beach County
            since 2023, built on 20+ years of hands-on expertise. We handle everything from
            panel upgrades and EV charger installation to full historic rewires, dock &amp; marina
            electrical, and FPL service undergrounding.
          </p>
          <p className="about__text">
            We&apos;re morally aimed — honest pricing, transparent communication, and work done right
            the first time. Florida State Certified Electrical Contractor EC-13012375, fully
        ...
        <div className="about__media">
          <div className="about__img-wrap">
            <Image
              src="/images/eccentric-about.webp"
              alt="Eccentric Energy electrician team"
              width={690}
              height={613}
            ...
            <div className="about__exp-box w-full! md:w-fit! flex! flex-row! gap-10!">
              ...
              <div className="about__exp-content flex flex-row gap-4">
                <span className="about__exp-number">20+</span>
