          ...
          <div className="contact-section__details">
            ...
            <div className="contact-section__details-col">
              ...
              <p className="contact-detail__value">
                5307 Spruce Ave, West Palm Beach,&nbsp;Florida
              </p>
            ...
            <div className="contact-section__details-col">
              ...
              <p className="contact-detail__value">
                <Link href="tel:+15619041990">561-904-1990</Link>
              </p>

              <h5 className="contact-detail__label">Email</h5>
              <p className="contact-detail__value">
                <Link href="mailto:EccentricEnergy@yahoo.com">EccentricEnergy@yahoo.com</Link>
              </p>
            </div>
