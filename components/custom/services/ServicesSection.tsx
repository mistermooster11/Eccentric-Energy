    ...
    <section className="services" ref={sectionRef}>
      ...
      <div className="services__header max-w-6xl! mx-auto">
        ...
        <p className="services__subtext">
          Residential and commercial electrical work — panel upgrades, EV chargers, rewires, dock &amp; marina,
          and specialty installs — handled by a state-certified contractor you can trust.
        </p>
      </div>
