  ...
  return (
    <section className="pricing" ref={sectionRef}>
      ...
      <div className="pricing__header">
        ...
        <h2 className="pricing__heading">Get a Free Estimate</h2>
        <p className="pricing__subtext">
          Upfront, honest pricing for every electrical project — from panel upgrades and EV charger installs
          to full historic rewires and emergency service calls across Palm Beach County.
        </p>
      </div>
