      ...
      <div className="testimonials__container">
        ...
        <div className="testimonials__header">
          ...
          <p className="testimonials__subtext">
            Our clients across Palm Beach County rely on Eccentric Energy for fast response, honest pricing,
            and electrical work done right the first time — from panel upgrades to emergency service calls.
          </p>
        </div>
