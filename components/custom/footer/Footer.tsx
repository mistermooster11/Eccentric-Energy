    ...
    <footer className="footer">
      ...
      <div className="footer__top">
        <div className="footer__brand">
          <Link href="/">
            <Image
              src="/eccentric-logo-darkBG.png"
              alt="Eccentric Energy Logo"
              width={239}
              height={58}
          ...
          <p className="footer__desc">
            <strong>Eccentric Energy</strong> is a family owned, Florida State Certified Electrical Contractor
            serving West Palm Beach and Palm Beach County. Panel upgrades, EV chargers, historic rewires,
            dock &amp; marina electrical, and 24/7 emergency service.
          </p>
      ...
      <div className="footer__bottom">
        <p className="footer__copyright">Copyright 2026 Eccentric Energy. All rights reserved.</p>
