      ...
      <div className="faq__container">
        ...
        <div className="faq__left">
          ...
          <p className="faq__subtext">
            Find clear answers about our residential and commercial electrical services — panel upgrades,
            EV chargers, historic rewires, dock &amp; marina electrical, and 24/7 emergency response.
          </p>
